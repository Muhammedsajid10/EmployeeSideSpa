...
const EmployeeManagementSystem = () => {
  ...
  const ProfilePage = () => {
    ...
    return (
      <div className="main-content profile-responsive">
        <div className="page-header profile-header-flex">
          <div>
          ...
          <button 
            ...
            disabled={loading}
            className="attendance-btn profile-refresh-btn"
          >
        ...
        {error && (
          <div className="error-alert profile-error-alert">
            {error}
          </div>
        )}
